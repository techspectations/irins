...
public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        public TextView heading, content,site;
        ...
        public MyViewHolder(View view) {
            ...
            site= (TextView) view.findViewById(R.id.sitename);
    ...
    public SearchAdapter(Context mContext, List<Search> albumList) {
        this.mContext = mContext;
        this.albumList = albumList;
    }
    public Context SearchAdapter() {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.searchcardtwo, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        final Search album = albumList.get(position);
        holder.heading.setText(album.getHeading());
        holder.content.setText(album.getContent());
        holder.site.setText(album.getSite());
        if(!album.getUrl().equals(""))
        Picasso.with(mContext).load(album.getUrl()).placeholder(R.drawable.progress_animation).into(holder.image);

        final DbHandler db1 = new DbHandler(SearchAdapter());
